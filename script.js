...
// When the editor saves, auto-download a fresh players.json for committing to the repo.
window.onPlayersSaved = function (playersArray) {
  ...
  a.download = "players.json"; // <- exact filename your app loads
  ...
  setTimeout(() => {
    alert(
      "✅ Players saved locally and a new players.json was downloaded.\n\n" +
      "To make these players load on every device, commit this file to your GitHub repo (replace the existing players.json)."
    );
  }, 50);
};
